...
@Log4j2
@Tag(name = "/v1/sellers/summaries")
@RestController
@RequestMapping(
    value = {"/v1/sellers/summary", "/v1/sellers/summaries"},
    produces = MediaType.APPLICATION_JSON_VALUE)
public class SellerSummaryDTOController {

  private final SellerSummaryDTOService sellerSummaryDTOService;

  public SellerSummaryDTOController(SellerSummaryDTOService sellerSummaryDTOService) {
    this.sellerSummaryDTOService = sellerSummaryDTOService;
  }
  ...
  public ResponseEntity<Page<SellerSummaryDTO>> findSummary(
    ...
    log.debug(
        "startDate={}, stopDate={}, qf={}, qt={}, pageable={}",
        startDate,
        stopDate,
        qf,
        qt,
    ...
    return ResponseEntity.ok(
        sellerSummaryDTOService.findSummary(
            ISO8601Util.parse(startDate), ISO8601Util.parse(stopDate), qf, qt, pageable));
  }
}
