 ...
 */
@Documented
@Constraint(validatedBy = {PlacementDTOAdSizeTypeValidator.class})
@Target({TYPE})
@Retention(RUNTIME)
public @interface PlacementDTOAdSizeTypeConstraint {
  String message() default "Placement AdSizeType is invalid for placementCategory";
