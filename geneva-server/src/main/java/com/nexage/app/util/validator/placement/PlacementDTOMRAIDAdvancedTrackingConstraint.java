 ...
 */
@Documented
@Constraint(validatedBy = {PlacementDTOMRAIDAdvancedTrackingValidator.class})
@Target({TYPE})
@Retention(RUNTIME)
public @interface PlacementDTOMRAIDAdvancedTrackingConstraint {
  String message() default "Invalid mraidAdvancedTracking value for PlacementCategory";

  String field() default "mraidAdvancedTracking";
