package com.ssp.geneva.sdk.xandr.validator;
...
class CurrencyCodeValidatorTest {
  ...
  void shouldReturnTrueWhenValidCodeProvided(String code, boolean valid) {
    assertEquals(valid, currencyCodeValidator.isValid(code, constraintValidatorContext));
  }

  @Test
  void shouldConstructCurrencyCodeValidator() {
