 ...
 *
 * <p>See http://github.com/yonik/java_util for future updates to this file.
 *
 * <p>IMPORTANT: This class was copied from the aol-dp-saf repo. Don't modify it!
 */
public final class MurmurHash3 {
  ...
  private static long fmix64(long k1) {
    k1 ^= k1 >>> 33;
  ...
  /**
   * Computes the 32-bit murmurHash function on a subarray with the given seed.
   *
  ...
  /**
   * Returns the 32-bit murmurHash function of the UTF-8 bytes of the String without actually
   * encoding the string to a temporary buffer. This is more than 2x faster than hashing the result
   * of String.getBytes().
   *
   * @param data The data to hash.
   * @param offset The start of the subarray.
  ...
  /**
   * Computes the 128-bit murmurHash function on a subarray with the given seed.
   *
   * @param key The data to hash.
   * @param offset The start of the subarray.
   * @param len The length of the subarray.
   * @param seed The seed to initialize the hash.
   * @param out The 128-bit hash result as a pair of longs.
   */
