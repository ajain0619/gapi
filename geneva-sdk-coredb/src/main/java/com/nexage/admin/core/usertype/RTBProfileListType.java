...
public class RTBProfileListType implements UserType {
  ...
  @Override
  public Class<ListType> returnedClass() {
  ...
  public void nullSafeSet(
    ...
    if (null == value) {
      ...
      st.setInt(index, ((ListType) value).getValue());
    }
  }
}
