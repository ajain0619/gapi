...
public class DealStatusUserType implements UserType {
  ...
  @Override
  public Class<DealStatus> returnedClass() {
  ...
  public Object nullSafeGet(
    ...
    if (!rs.wasNull()) {
      result = DealStatus.fromInt(value);
    }
    return result;
  }
  ...
  public void nullSafeSet(
    ...
    if (null == value) {
      ...
      st.setInt(index, ((DealStatus) value).asInt());
    }
  }
}
