...
public class MatchTypeEnumType implements UserType {
  ...
  @Override
  public Class<MatchType> returnedClass() {
  ...
  public Object nullSafeGet(
    ...
    if (!rs.wasNull()) {
      result = MatchType.fromInt(value);
    }
    return result;
  }
  ...
  public void nullSafeSet(
    ...
    if (null == value) {
      ...
      st.setInt(index, ((MatchType) value).asInt());
    }
  }
