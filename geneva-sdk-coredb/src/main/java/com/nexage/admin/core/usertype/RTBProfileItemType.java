...
public class RTBProfileItemType implements UserType {
  ...
  @Override
  public Class<ItemType> returnedClass() {
  ...
  public void nullSafeSet(
    ...
    if (null == value) {
      ...
      st.setInt(index, ((ItemType) value).getValue());
    }
  }
}
