...
VALUES (1, 1, 1, 1, 'rule name 1', 'rule description 1', now(), 0);

INSERT INTO rule (pid, company_pid, version, status, name, description, last_update, rule_type)
VALUES (2, 1, 1, 1, 'rule name 2', 'rule description 2', now(), 0);

INSERT INTO rule (pid, company_pid, version, status, name, description, last_update, rule_type)
VALUES (3, 1, 1, -1, 'rule name 3', 'rule description 3', now(), 0);

INSERT INTO company_rule (company_pid, rule_pid)
VALUES (1, 1);
